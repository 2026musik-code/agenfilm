    ...
    <section className="py-10 border-b border-luxury-gray/30 last:border-0 relative">
      <div className="container mx-auto px-4 mb-6 flex justify-between items-end">
        <div>
          ...
          {subTitle && <p className="text-gray-400 text-sm mt-1 pl-5">{subTitle}</p>}
        </div>
        {columnId && (
          <Link
      ...
      <div className="relative group">
        <div className="flex overflow-x-auto space-x-6 pb-8 px-4 md:px-8 scroll-smooth snap-x snap-mandatory scrollbar-hide">
          {bookList.map((drama) => (
